        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          {MAIN_FEATURES.map((f, i) => (
            <Reveal key={f.title} delay={i * 100}>
              <div className="rounded-xl p-6 border border-slate-200 bg-white h-full hover:-translate-y-1 hover:shadow-xl hover:border-blue-200 transition-all duration-200">
                <div
                ...
                <p className="text-sm mb-4 leading-6 text-slate-600">
                  {f.desc}
                </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {EXTRA_FEATURES.map((f, i) => (
            <Reveal key={f.title} delay={i * 80}>
              <div className="flex items-start gap-4 rounded-xl p-5 border border-slate-200 bg-slate-50 hover:-translate-y-0.5 hover:shadow-md transition-all duration-200">
                <div
                ...
                <div>
                  <h4 className="font-bold mb-1 text-slate-900">{f.title}</h4>
